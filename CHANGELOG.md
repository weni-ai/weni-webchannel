...
* feat: adds setCustomField method
...
* feat: adds `forceThinkingAfterSendingMessage` parameter to enables Thinking immediately after sending a message
...
### [2.19.4](https://https//github.com/push-platform/push-webchat/compare/v2.19.3...v2.19.4) (2024-12-12)
